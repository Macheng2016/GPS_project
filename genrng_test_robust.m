function [prvec,adrvec,pr_err_vec]=genrng_test_robust(rxid,usrxyz,svmat,svid,time,esf,...  %pr_err_vec added by macshen
...
for N = 1:numvis,
   ...
   if ((mpflg~=0)|(saflg~=0)),
    ...
    if N>=7
        mperrpr=0;   %added by macshen for test purpose
    end
